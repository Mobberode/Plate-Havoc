...
execute if score #BorderType plate_havoc.num matches 3 run return run data modify storage plate_havoc:custom border_says_warnings set value "Jump or Sneak!"
...
execute if score #BorderType plate_havoc.num matches 5 run return run data modify storage plate_havoc:custom border_says_warnings set value "Jump or Sprint!"
execute if score #BorderType plate_havoc.num matches 6 run return run data modify storage plate_havoc:custom border_says_warnings set value "Sprint or Sneak!"
execute if score #BorderType plate_havoc.num matches 7 run return run data modify storage plate_havoc:custom border_says_warnings set value "Sprint, Sneak or Jump!"