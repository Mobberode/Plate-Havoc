...
execute as @n[type=marker,tag=plate_havoc_content.misc.lava_rush.generation] at @s run function plate_havoc_legacy_content:gametypes/prematch/lava_rush/generate
kill @e[type=item]