...
data modify storage plate_havoc:ui bar.global.snbt[{id:time}].extra set value [{meta:default,text:"Time: "},{score:{name:"#Visual.Left.Second",objective:plate_havoc.timer},color:yellow},".",{score:{name:"#Visual.Left.Tick",objective:plate_havoc.timer},color:yellow}]
...
function plate_havoc_legacy_content:gametypes/prematch/arena/random
