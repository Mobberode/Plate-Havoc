...
execute unless entity @p[tag=plate_havoc.survivor,tag=!plate_havoc.juggernaut] run function plate_havoc_legacy_content:gametypes/player/juggernaut/jug_win