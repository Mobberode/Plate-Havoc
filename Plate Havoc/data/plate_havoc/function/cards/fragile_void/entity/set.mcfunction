...
#Scale/Hitbox
execute store result score @s plate_havoc.temp store result score @s plate_havoc.c.card.fragile_void.starting_scale run random value 45..125

function plate_havoc:cards/fragile_void/entity/offset
