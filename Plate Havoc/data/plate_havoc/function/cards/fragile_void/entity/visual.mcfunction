...
function plate_havoc:cards/fragile_void/entity/set_scale

##Pos
execute summon marker run function plate_havoc:cards/fragile_void/entity/get_pos
execute at @s run function plate_havoc:cards/fragile_void/entity/particles with storage plate_havoc:cards