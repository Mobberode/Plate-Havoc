scoreboard players operation #Template.Event.Motion_Sniper.Ammo plate_havoc.num *= #4 plate_havoc.num
scoreboard players operation #Template.Event.Motion_Sniper.Damage_Multiplier plate_havoc.num /= #2 plate_havoc.num

scoreboard players operation #Template.Event.Motion_Sniper.Delay plate_havoc.num /= #4 plate_havoc.num
