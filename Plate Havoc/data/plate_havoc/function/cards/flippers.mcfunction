...
##Apply to players
execute as @a[tag=plate_havoc.survivor] run function plate_havoc:cards/flippers/apply with storage plate_havoc:cards

#V
tellraw @a [{text:"Flippers Water Mobility Multiplier: ",color:aqua},{storage:"plate_havoc:cards",nbt:temp,color:gold}]