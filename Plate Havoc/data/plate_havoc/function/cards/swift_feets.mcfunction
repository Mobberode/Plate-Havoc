##Set to 5
scoreboard players set #Temp plate_havoc.card 30
##Card level
...
##Apply to players
execute as @a[tag=plate_havoc.survivor] run function plate_havoc:cards/swift_feets/apply with storage plate_havoc:cards

#V
tellraw @a [{text:"Swift Feets Gain: ",color:aqua},{storage:"plate_havoc:cards",nbt:temp,color:gold}]