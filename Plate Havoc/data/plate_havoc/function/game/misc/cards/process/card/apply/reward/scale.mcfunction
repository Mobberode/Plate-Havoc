...
execute if score #Temp5 plate_havoc.temp matches 1.. run function plate_havoc:game/misc/cards/process/card/apply/reward/scale with storage plate_havoc:temp temp