...
execute if function plate_havoc:game/misc/cards/process/types/check run return run data modify storage plate_havoc:cards active_types prepend from storage plate_havoc:cards temp_type
