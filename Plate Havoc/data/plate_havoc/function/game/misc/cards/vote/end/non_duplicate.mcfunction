...
data modify storage plate_havoc:temp temp.hover_event.value append from storage plate_havoc:cards template.data.snbt.name
data modify storage plate_havoc:temp temp.hover_event.value append value "\n"
