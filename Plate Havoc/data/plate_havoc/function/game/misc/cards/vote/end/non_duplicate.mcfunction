...
data modify storage plate_havoc:temp temp.extra[{id:description}].extra prepend from storage plate_havoc:cards snbt.extra[0]
data modify storage plate_havoc:temp temp.extra append value {id:seperator,text:", "}
