...
data modify storage plate_havoc:cards template_running.visual.extra[{id:description}].extra append from storage plate_havoc:cards template.text.body.extra[0]
