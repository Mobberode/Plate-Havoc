...
data modify storage plate_havoc:cards template_running.visual.extra[{id:description}].extra append from storage plate_havoc:cards template.body.extra[0]
...
data modify storage plate_havoc:cards template_running.visual.extra[{id:count}].extra[{part:count}].text set string storage plate_havoc:cards template_running.count
#
