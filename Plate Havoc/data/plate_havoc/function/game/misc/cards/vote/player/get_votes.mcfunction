...
data modify storage plate_havoc:cards active_entry.data.snbt.action.label[{meta:votes}].extra[{part:count}].text set string storage plate_havoc:cards active_entry.values.votes