...
execute store result score #CyclathronCost plate_havoc.num run data get storage plate_havoc:temp temp.active.values.cost 100

scoreboard players set #CyclathronGain plate_havoc.num 0
execute store result score #CyclathronGain plate_havoc.num run data get storage plate_havoc:temp temp.active.values.reward 100
