...
data remove storage plate_havoc:cards template_running.exclusive[-1]
execute if data storage plate_havoc:cards template_running.exclusive[-1] run function plate_havoc:game/misc/cards/pool/exclusive/loop