...
##Loop
execute if score #Success plate_havoc.num matches 1.. if data storage plate_havoc:cards current_requirement.needed[-1] run return run function plate_havoc:game/misc/cards/locked/type/multi_condition/check/card