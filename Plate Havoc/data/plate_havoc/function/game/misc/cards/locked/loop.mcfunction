...
function plate_havoc:game/misc/cards/locked/requirement

data remove storage plate_havoc:cards temp_locked[-1]
execute if data storage plate_havoc:cards temp_locked[-1] run function plate_havoc:game/misc/cards/locked/loop