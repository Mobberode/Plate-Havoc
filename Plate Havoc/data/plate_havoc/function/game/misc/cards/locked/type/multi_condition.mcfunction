...
##Check
function plate_havoc:game/misc/cards/locked/type/multi_condition/check

#Remove
data remove storage plate_havoc:cards temp_locked[-1].requirement.conditions[-1]

##Loop
execute if score #Success plate_havoc.num matches 1.. run function plate_havoc:game/misc/cards/locked/type/multi_condition/loop_back