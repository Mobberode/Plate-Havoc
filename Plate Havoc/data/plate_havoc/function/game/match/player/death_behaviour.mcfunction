...
##LMS
execute if score #Temp plate_havoc.temp matches ..0 if entity @a[tag=plate_havoc.survivor,limit=1] run function plate_havoc:game/match/player/last_one with storage plate_havoc:data
