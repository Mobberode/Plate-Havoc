...
execute if score #GreenTeam plate_havoc.players matches ..0 unless score #YellowTeam plate_havoc.players matches ..0 run return run function plate_havoc:game/match/player/teams/green_win
execute if score #YellowTeam plate_havoc.players matches ..0 unless score #GreenTeam plate_havoc.players matches ..0 run return run function plate_havoc:game/match/player/teams/yellow_win
