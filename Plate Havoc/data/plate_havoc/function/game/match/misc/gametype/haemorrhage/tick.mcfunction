execute as @e[tag=plate_havoc.haemorrhage.heal] at @s run function plate_havoc:game/match/misc/gametype/haemorrhage/heart/check
execute as @e[tag=plate_havoc.haemorrhage.heal.init] at @s in plate_havoc:arena run function plate_havoc:game/match/misc/gametype/haemorrhage/heart/set
