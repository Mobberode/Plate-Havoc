...
execute store result score #Temp plate_havoc.intensity run data get storage plate_havoc:temp temp.intensity 1000
execute store result score #Temp2 plate_havoc.intensity run data get storage plate_havoc:temp temp.max_intensity 1000
