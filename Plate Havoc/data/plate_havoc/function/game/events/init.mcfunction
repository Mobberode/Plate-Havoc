...
execute unless data storage plate_havoc:events running[] run data modify storage plate_havoc:events running set value []
...
function plate_havoc:game/misc/cards/running/types/run {type:on.action}