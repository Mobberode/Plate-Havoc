...
execute store result bossbar plate_havoc:status value run scoreboard players operation #EventMessage.Timer plate_havoc.timer -= #EventMessage.Time.Remove plate_havoc.temp
