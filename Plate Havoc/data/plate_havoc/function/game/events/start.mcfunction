...
data modify storage plate_havoc match_events set from storage plate_havoc events_pool

execute store result score #Value plate_havoc.rng if data storage plate_havoc events_pool[]
