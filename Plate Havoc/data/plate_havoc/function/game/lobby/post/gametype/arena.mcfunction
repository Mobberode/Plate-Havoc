...
data modify storage plate_havoc spectator_tick_function set value "plate_havoc:game/match/misc/gametype/arena/tick"

data modify storage plate_havoc game_end_condition_function set value "plate_havoc:game/match/player/arena/check"
