...
execute if score #GreenTeam plate_havoc.players < #YellowTeam plate_havoc.players run return run function plate_havoc:game/lobby/post/gametype/internal/teams/green
