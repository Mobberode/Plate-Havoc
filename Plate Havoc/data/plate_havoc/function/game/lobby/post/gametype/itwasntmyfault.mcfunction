...
data modify storage plate_havoc:ui bar_visuals_queue[{id:players}] set value {id:players,text:"",extra:[{text:"Alive: "},{score:{name:"#Current",objective:plate_havoc.players},color:green}]}
