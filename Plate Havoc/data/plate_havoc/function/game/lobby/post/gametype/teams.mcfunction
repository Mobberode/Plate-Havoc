...
data modify storage plate_havoc:ui bar.queue append value {id:players,text:"",extra:[{text:""},{score:{name:"#GreenTeam",objective:plate_havoc.players},color:green},{text:" v "},{score:{name:"#YellowTeam",objective:plate_havoc.players},color:yellow}]}
...
data modify storage plate_havoc:data on_game_start append value "plate_havoc:game/lobby/post/gametype/internal/teams/run"
