...
execute if score #LBEntries plate_havoc.num < #LBLimit plate_havoc.config run function plate_havoc:game/leaderboard/sort with storage plate_havoc:leaderboard