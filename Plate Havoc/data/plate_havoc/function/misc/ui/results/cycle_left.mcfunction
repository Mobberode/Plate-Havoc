...
scoreboard players remove @s plate_havoc.z.view_run.player 1
execute if score @s plate_havoc.z.view_run.player matches ..-1 run scoreboard players operation @s plate_havoc.z.view_run.player = @s plate_havoc.z.view_run.player_highest
