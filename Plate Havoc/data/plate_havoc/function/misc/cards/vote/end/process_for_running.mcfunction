...
execute unless score #Card.Continue plate_havoc.num matches 1.. unless data storage plate_havoc:cards {attributes:{selection:{replace_cards:false}}} run return run function plate_havoc:misc/cards/process/attributes/selection/insert