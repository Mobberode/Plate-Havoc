...
execute store result score #VotingPercentage plate_havoc.temp run function plate_havoc:misc/cards/vote/requirement/get_percentage
#*Voting Percentage
...
execute if score #Match plate_havoc.players matches 2.. if function plate_havoc:misc/cards/vote/requirement/rounding/check run function plate_havoc:misc/cards/vote/requirement/rounding/run
