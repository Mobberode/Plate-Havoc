...
##Set to temp
function plate_havoc:misc/cards/vote/player/transfer with storage plate_havoc:cards
...
##Update from temp
function plate_havoc:misc/cards/vote/player/upload with storage plate_havoc:cards