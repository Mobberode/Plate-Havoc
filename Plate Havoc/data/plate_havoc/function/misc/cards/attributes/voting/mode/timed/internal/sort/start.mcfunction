...
function plate_havoc:misc/cards/attributes/voting/mode/timed/internal/sort/loop

execute store result storage plate_havoc:temp votes int 1 run scoreboard players get #Sort plate_havoc.temp
function plate_havoc:misc/cards/attributes/voting/mode/timed/internal/sort/end with storage plate_havoc:temp

function plate_havoc:misc/cards/attributes/voting/mode/timed/internal/sort/dual_check

function plate_havoc:misc/cards/attributes/voting/mode/timed/internal/sort/final_check