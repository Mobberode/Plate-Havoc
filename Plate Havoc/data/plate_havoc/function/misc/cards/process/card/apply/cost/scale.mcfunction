...
execute if score #Temp5 plate_havoc.temp matches 1.. run function plate_havoc:misc/cards/process/card/apply/cost/scale with storage plate_havoc:temp temp