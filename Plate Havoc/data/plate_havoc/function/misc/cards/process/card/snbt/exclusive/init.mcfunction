##exclusive
data modify storage plate_havoc:temp temp set value {meta:exclusive,text:"ℹ",color:yellow,hover_event:{action:"show_text",value:[{meta:exclusive,text:"⌀",extra:[" ",{translate:"plate_havoc:card.info.exclusive",fallback:"Exclusive Cards"},"\n"]}]}}
...
data modify storage plate_havoc:temp temp.hover_event.value[{meta:exclusive}].extra insert -1 from storage plate_havoc:temp temp2.output[]
