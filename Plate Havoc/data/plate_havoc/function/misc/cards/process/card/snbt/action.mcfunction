...
data modify storage plate_havoc:temp temp.temp merge from storage plate_havoc:temp input.name
execute unless data storage plate_havoc:temp temp.temp.translate run data modify storage plate_havoc:temp temp.temp.text set from storage plate_havoc:temp input.name
