...
#Active
function plate_havoc:misc/cards/pool/active/run

data remove storage plate_havoc:cards select_pool[0]

#If more
execute if data storage plate_havoc:cards select_pool[-1] run function plate_havoc:misc/cards/process/loopback