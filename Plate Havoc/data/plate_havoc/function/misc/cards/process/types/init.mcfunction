execute unless data storage plate_havoc:cards active_types[] run data modify storage plate_havoc:cards active_types set value []
...
function plate_havoc:misc/cards/process/types/loop