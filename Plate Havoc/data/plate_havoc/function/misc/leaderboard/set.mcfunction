...
function plate_havoc:misc/leaderboard/add with storage plate_havoc:leaderboard editing
function plate_havoc:misc/leaderboard/apply with storage plate_havoc:data gametype