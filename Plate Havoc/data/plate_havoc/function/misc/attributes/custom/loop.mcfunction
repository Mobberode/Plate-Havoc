...
execute if data storage plate_havoc:custom attribute.internal[-1] run function plate_havoc:misc/attributes/custom/operation/add_value
...
execute if data storage plate_havoc:custom attribute.internal[-1] run function plate_havoc:misc/attributes/custom/operation/add_multiplied_base
