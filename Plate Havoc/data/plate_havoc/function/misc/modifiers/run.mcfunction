...
execute if score #Modifiers.Chance plate_havoc.temp >= #RNG plate_havoc.num run function plate_havoc:misc/modifiers/select

scoreboard players add #Modifiers.Current_Entries plate_havoc.temp 1

execute unless score #Modifiers.Current_Entries plate_havoc.temp >= #Modifiers.Entries plate_havoc.temp run function plate_havoc:misc/modifiers/run