execute unless data storage plate_havoc:data content.modifiers[-1] run return fail

data modify storage plate_havoc:modifiers pool set from storage plate_havoc:data content.modifiers
