...
{id:iron_golem,intensity:5.25,function:"plate_havoc:events/iron_golem"},\
{id:bridge,intensity:0.6,function:"plate_havoc:events/bridge"},\
{id:ghast,intensity:7,function:"plate_havoc:events/ghast"},\
{id:acid_rain,intensity:7.5,function:"plate_havoc:events/multi_sequence/acid_rain/start"},\
{id:null,intensity:5.8,function:"plate_havoc:events/null"},\
...
{id:wither,intensity:8,function:"plate_havoc:events/wither"},\
...
{id:fireworks,intensity:2.8,function:"plate_havoc:events/multi_sequence/fireworks/start"},\
...
{id:herobrine,intensity:4.1,function:"plate_havoc:events/multi_sequence/herobrine/start"},\
...
{id:egg_rain,intensity:2.6,function:"plate_havoc:events/multi_sequence/egg_rain/start"},\
{id:nuke,intensity:6.4,function:"plate_havoc:events/multi_sequence/nuke/start"},\
{id:piranha,intensity:3.1,function:"plate_havoc:events/multi_sequence/piranha/start"},\
]