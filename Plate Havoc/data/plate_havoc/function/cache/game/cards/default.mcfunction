...
\
{id:netherite_clock,type:positive,cost:100,requirement:{type:cycle,cycle:20},body:{text:"",extra:[{text:"Netherite Clock",color:green},{text:"\n+250% Cyclathrons. +2 Time Reduction"}]},action:{label:[{text:"Netherite Clock"}]},on_select:{functions:[],duration:-1,left:1}},\
\
\
\
