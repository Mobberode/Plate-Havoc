...
\
{id:swift_feets,type:positive,body:{text:"",extra:[{text:"Swift Feets",color:green},{text:"\n+5% to Movement Speed. Stackable."}]},action:{label:[{text:"Swift Feets"}]},on_select:{function:"plate_havoc:cards/swift_feets",duration:-1,left:-1,type:on_start}},\
\
...
\
{id:armoured_up,type:positive,body:{text:"",extra:[{text:"Armoured Up",color:green},{text:"\nIncreases Armour by 2 and Toughness by half. Usable 5 times"}]},action:{label:[{text:"Armoured Up"}]},on_select:{function:"plate_havoc:cards/armoured_up",duration:-1,left:5,type:on_start}},\
\
...
\
{id:clocking_out,type:positive,body:{text:"",extra:[{text:"Clocking Out",color:green},{text:"\nMake the Cycles 4 seconds shorter. Stackable"}]},action:{label:[{text:"Clocking Out"}]},on_select:{function:"plate_havoc:cards/clocking_out",duration:1,left:-1,type:on_start}},\
\
{id:locked_spacebar,type:negative,body:{text:"",extra:[{text:"Locked Spacebar",color:red},{text:"\nDisables the ability to jump permanently for the run but swimming in water and lava is kept. Disables the Jump Cooldown event"}]},action:{label:[{text:"Locked Spacebar"}]},on_select:{function:"plate_havoc:cards/locked_spacebar",duration:-1,left:1,type:on_start}},\
\
{id:piranha_season,type:negative,body:{text:"",extra:[{text:"Piranha Season",color:red},{text:"\nPiranhas deal +2.5 (1.5 Hearts) more damage to players"}]},action:{label:[{text:"Piranha Season"}]},on_select:{function:"plate_havoc:cards/piranha_season",duration:-1,left:1,type:on_start}},\
\
{id:enraged,type:negative,body:{text:"",extra:[{text:"Enraged",color:red},{text:"\nIncreased event frequency (-25% Event Time Percentage) and intensity gain (+30% Intensity Gain Percentage) Usable 2 times"}]},action:{label:[{text:"Enraged"}]},on_select:{function:"plate_havoc:cards/enraged",duration:1,left:2,type:on_start}},\
\
...
\
{id:silverfestation,type:negative,body:{text:"",extra:[{text:"Silverfestation",color:red},{text:"\nEvery mob is given the Infested effect"}]},action:{label:[{text:"Silverfestation"}]},on_select:{function:"plate_havoc:cards/silverfestation",duration:-1,left:1,type:loop}},\
\
{id:close_up,type:negative,body:{text:"",extra:[{text:"Close Up",color:red},{text:"\nThe Third Person camera is more closer to the player, lessening it's effectiveness on providing a view around the player's surroundings"}]},action:{label:[{text:"Close Up"}]},on_select:{function:"plate_havoc:cards/close_up",duration:-1,left:1,type:on_start}},\
]
#
