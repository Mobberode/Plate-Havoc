...
\
{id:swift_feets,type:positive,cost:4,body:{text:"",extra:[{text:"Swift Feets",color:green},{text:"\nIncrease Movement Speed (10% *Level) (Max: 3)"}]},action:{label:[{text:"Swift Feets"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/swift_feets/start"}],duration:-1,left:3}},\
\
{id:hearty,type:positive,cost:5,body:{text:"",extra:[{text:"Hearty",color:green},{text:"\nIncreases Max Health (2.5 *Level) (Max: 4)"}]},action:{label:[{text:"Hearty"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/hearty/start"}],duration:-1,left:4}},\
\
{id:armoured_up,type:positive,cost:7,body:{text:"",extra:[{text:"Armoured Up",color:green},{text:"\nGain Armour (2 *Level) and Toughness (Armour /2) (Max: 5)"}]},action:{label:[{text:"Armoured Up"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/armoured_up/start"}],duration:-1,left:5}},\
\
{id:strength_training,type:positive,cost:8,body:{text:"",extra:[{text:"Strength Training",color:green},{text:"\nHits hit harder (2 *Level) (Max: 3)"}]},action:{label:[{text:"Strength Training"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/strength_training/start"}],duration:1,left:3}},\
\
{id:flippers,type:positive,requirement:{type:cycle,cycle:3},cost:8,body:{text:"",extra:[{text:"Flippers",color:green},{text:"\nIncreases Water Mobility by (+0.1 *Level) (Max: 2)"}]},action:{label:[{text:"Flippers"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/flippers/start"}],duration:-1,left:2}},\
\
...
\
{id:shearing_webs,type:positive,requirement:{type:cycle,cycle:5},cost:20,body:{text:"",extra:[{text:"Shearing Webs",color:green},{text:"\nShear away cobwebs that players step on"}]},action:{label:[{text:"Shearing Webs"}]},on_select:{functions:[{type:loop,function:"plate_havoc:cards/shearing_webs/loop"}],duration:-1,left:1}},\
\
{id:hands_of_creativity,type:positive,requirement:{type:cycle,cycle:5},cost:37.5,body:{text:"",extra:[{text:"Hands of Creativity",color:green},{text:"\nGain the ability to break and place blocks but range is cut by a third"}]},action:{label:[{text:"Hands of Creativity"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/hands_of_creativity/start"}],duration:-1,left:1}},\
\
{id:box_of_meats,type:positive,requirement:{type:cycle,cycle:5},cost:25,body:{text:"",extra:[{text:"Box of Meats",color:green},{text:"\n3 Cooked Mutton for all players"}]},action:{label:[{text:"Box of Meats"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/box_of_meats/start"}],duration:-1,left:1}},\
\
{id:intense_investment,type:positive,requirement:{type:cycle,cycle:5},cost:35,body:{text:"",extra:[{text:"Intense Investment",color:green},{text:"\n10% of Intensity is turned into Cyclathrons at the end of a Cycle"}]},action:{label:[{text:"Intense Investment"}]},on_select:{functions:[{type:on.end,function:"plate_havoc:cards/intense_investment/end"}],duration:-1,left:1}},\
\
{id:diamond_clock,type:positive,requirement:{type:multi_condition,conditions:[{type:card,needed:[{id:iron_clock,count:1}]},{type:cycle,cycle:7}]},cost:50,body:{text:"",extra:[{text:"Diamond Clock",color:green},{text:"\n+50% Cyclathrons and Events happen +50% slower. +1 Time Reduction on Clock Collect. This card will be fully completed at a later date"}]},action:{label:[{text:"Diamond Clock"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/diamond_clock/start"}],duration:1,left:1}},\
\
...
\
{id:octagonal_move_normalizer,type:positive,requirement:{type:multi_condition,conditions:[{type:cycle,cycle:10},{type:card,needed:[{id:swift_feets,count:3},{id:flippers,count:2}]}]},cost:80,body:{text:"",extra:[{text:"Octagonal Move-Normalizer",color:green},{text:"\n+100% Movement Efficency alongside +30% Speed, *2 Water Mobility Percentage"}]},action:{label:[{text:"Octagonal Move-Normalizer"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/octagonal_move_normalizer/start"}],duration:-1,left:1}},\
\
{id:vampiristic_lifeblood,type:positive,requirement:{type:cycle,cycle:10},cost:100,body:{text:"",extra:[{text:"Vampiristic Lifeblood",color:green},{text:"\nKilling Mobs restores the killer's health. Increases Max Health by 10"}]},action:{label:[{text:"Vampiristic Lifeblood"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/vampiristic_lifeblood/start"},{type:loop,function:"plate_havoc:cards/vampiristic_lifeblood/loop"}],duration:-1,left:1}},\
\
{id:gods_hand,type:positive,requirement:{type:multi_condition,conditions:[{type:cycle,cycle:10},{type:card,needed:[{id:hands_of_creativity,count:1}]}]},cost:125,body:{text:"",extra:[{text:"God's Hands",color:green},{text:"\nUnlock your full potential. Block range no longer halved and now has increased range (+1 Range). Interact with Mobs farther away (+1 Range) Blocks now drop alongside Mob Loot, allowing the ability to craft"}]},action:{label:[{text:"God's Hands"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/gods_hand/start"}],duration:-1,left:1}},\
\
\
\
{id:faulty_spacebar,type:negative,reward:25,requirement:{type:cycle,cycle:12},body:{text:"",extra:[{text:"Faulty Spacebar",color:red},{text:"\nJumping will be periodically locked and unlocked"}]},action:{label:[{text:"Faulty Spacebar"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/faulty_spacebar/start"},{type:loop,function:"plate_havoc:cards/faulty_spacebar/loop"}],duration:-1,left:1}},\
\
...
\
{id:higher_gravity,type:negative,body:{text:"",extra:[{text:"Higher Gravity",color:red},{text:"\n+15% Gravity but take +15% more Fall Damage"}]},action:{label:[{text:"Higher Gravity"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/higher_gravity/start"}],duration:-1,left:1}},\
\
...
\
{id:close_up,type:negative,body:{text:"",extra:[{text:"Close Up",color:red},{text:"\nThe Third Person camera is 2.75 blocks closer to the player, lessening it's effectiveness on providing a view around the player's surroundings"}]},action:{label:[{text:"Close Up"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/close_up/start"}],duration:-1,left:1}},\
\
{id:fragile_legs,type:negative,body:{text:"",extra:[{text:"Fragile Legs",color:red},{text:"\nFall Damage is multiplied (+115% *Level) (Max: 2)"}]},action:{label:[{text:"Fragile Legs"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/fragile_legs/start"}],duration:-1,left:2}},\
\
...
\
{id:abyssal_reach,type:negative,reward:25,requirement:{type:cycle,cycle:10},body:{text:"",extra:[{text:"Abyssal Reach",color:red},{text:"\nTeetering on the brink, facing the abyss... The Void is 32 blocks closer and deadlier"}]},action:{label:[{text:"Abyssal Reach"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/abyssal_reach/start"}],duration:1,left:1}},\
\
{id:broken_notifier,type:negative,reward:75,requirement:{type:cycle,cycle:12},body:{text:"",extra:[{text:"Broken Notifier",color:red},{text:"\nEvent Notifiers are hidden"}]},action:{label:[{text:"Broken Notifier"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/broken_notifier/start"}],duration:1,left:1}},\
\
{id:pitch_black,type:negative,reward:30,requirement:{type:multi_condition,conditions:[{type:cycle,cycle:12},{type:card,needed:[{id:abyssal_reach,count:1}]}]},body:{text:"",extra:[{text:"Pitch Black",color:red},{text:"\nDark consumes all. Shrouded in Darkness, players will slowly wither away if left in the dark for 10 seconds"}]},action:{label:[{text:"Pitch Black"}]},on_select:{functions:[{type:loop,function:"plate_havoc:cards/pitch_black/loop"}],duration:-1,left:1}},\
\
...
#{id:digital_glacier,type:negative,requirement:{type:cycle,cycle:10},body:{text:"",extra:[{text:"Digital Glacier Player",color:red},{text:"\n"}]},action:{label:[{text:"Digital Glacier Player"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/hatred/start"}],duration:1,left:1}},\
