...
\
{id:chilled_temper,type:positive,cost:15,body:{text:"",extra:[{text:"Chilled Temper",color:green},{text:"\n-10% Intensity Gain Percentage"}]},action:{label:[{text:"Chilled Temper"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/chilled_temper/start"}],duration:1,left:1}},\
\
...
\
{id:gravity_coil,type:positive,cost:-300,requirement:{type:cycle,cycle:20},body:{text:"",extra:[{text:"Gravity Coil",color:green},{text:"\n"}]},action:{label:[{text:"Gravity Coil"}]},on_select:{functions:[],duration:-1,left:1}},\
\
...
\
{id:enraged,type:negative,exclusive:[{id:slow_passing}],body:{text:"",extra:[{text:"Enraged",color:red},{text:"\n+20% event frequency, +15% Intensity gain and +115% Cyclathrons (Max: 2)"}]},action:{label:[{text:"Enraged"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/enraged/start"}],duration:1,left:2}},\
\
...
\
{id:rf_strike_pack,type:negative,requirement:{type:cycle,cycle:10},body:{text:"",extra:[{text:"RF Strike Pack",color:red},{text:"\nMotion Snipers shoot faster at rapid fire speeds. Ammo is multiplied by 3x and Damage is halved to compenstate for increased rate of fire"}]},action:{label:[{text:"RF Strike Pack"}]},on_select:{functions:[{type:on.start,function:"plate_havoc:cards/rf_strike_pack/start"}],duration:1,left:1}},\
\
