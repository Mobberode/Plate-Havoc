...
#{id:abyssal_reach,type:negative,requirement:{type:cycle,cycle:12},body:{text:"",extra:[{text:"Abyssal Reach",color:red},{text:"\nTeetering on the brink, facing the abyss... The Void is closer and will be fatal"}]},action:{label:[{text:"Abyssal Reach"}]},on_select:{function:"plate_havoc:cards/locked_spacebar",duration:-1,left:1,type:on_start}},\
