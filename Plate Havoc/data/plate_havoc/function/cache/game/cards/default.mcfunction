...
{id:iron_clock,type:positive,cost:10,body:{text:"",extra:[{text:"Iron Clock",color:green},{text:"\n+25% Cyclathrons and Events happen +10% slower"}]},action:{label:[{text:"Iron Clock"}]},on_select:{function:"plate_havoc:cards/iron_clock",duration:1,left:1,type:on.start}},\
\
...
\
{id:diamond_clock,type:positive,requirement:{type:multi_condition,conditions:[{type:card,needed:[{id:iron_clock,count:1}]},{type:cycle,cycle:7}]},cost:50,body:{text:"",extra:[{text:"Diamond Clock",color:green},{text:"\n+50% Cyclathrons and Events happen +50% slower. This card will be fully completed at a later date"}]},action:{label:[{text:"Diamond Clock"}]},on_select:{function:"plate_havoc:cards/diamond_clock",duration:1,left:1,type:on.start}},\
\
...
\
{id:enraged,requirement:{type:cycle,cycle:3},type:negative,body:{text:"",extra:[{text:"Enraged",color:red},{text:"\n-33% event frequency, +33% Intensity gain and +33% Cyclathrons (Max: 2)"}]},action:{label:[{text:"Enraged"}]},on_select:{function:"plate_havoc:cards/enraged",duration:1,left:2,type:on.start}},\
\
