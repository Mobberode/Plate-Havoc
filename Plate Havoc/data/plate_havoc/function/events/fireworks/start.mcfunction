...
execute if score #Fireworks.Summon plate_havoc.event matches 1.. run return run function plate_havoc:events/fireworks/extend
...
function plate_havoc:events/fireworks/run