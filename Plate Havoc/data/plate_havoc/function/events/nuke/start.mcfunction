...
execute as @n[type=marker,tag=plate_havoc.event_place] run function plate_havoc:events/nuke/action with storage plate_havoc:events

function plate_havoc:events/nuke/loop