...
execute unless score #EventRunCount plate_havoc.num >= #Template.Event.Laser_Drill.MaxRunCount plate_havoc.num run function plate_havoc:events/laser_drill/run