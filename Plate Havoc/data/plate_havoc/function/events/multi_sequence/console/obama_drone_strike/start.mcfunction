execute if score #ObamaDroneStrike plate_havoc.timer matches 1.. run return run function plate_havoc:events/multi_sequence/console/obama_drone_strike/extend
...
scoreboard players set #ObamaDroneStrike plate_havoc.timer 500
