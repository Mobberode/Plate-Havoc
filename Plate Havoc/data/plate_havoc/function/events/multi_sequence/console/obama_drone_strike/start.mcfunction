execute if score #ObamaDroneStrike plate_havoc.event matches 1.. run return run function plate_havoc:events/multi_sequence/console/obama_drone_strike/extend
...
tellraw @a {text:"OBAMA DRONE STRIKE!!!",color:gold}
scoreboard players operation #ObamaDroneStrike plate_havoc.event = #Template.Event.ObamaDroneStrike plate_havoc.num
function plate_havoc:events/multi_sequence/console/obama_drone_strike/loop