...
scoreboard players remove #ObamaDroneStrike plate_havoc.timer 1
function plate_havoc:events/multi_sequence/console/obama_drone_strike/init

execute if score #ObamaDroneStrike plate_havoc.timer matches 1.. run return run schedule function plate_havoc:events/multi_sequence/console/obama_drone_strike/loop 1t
