execute if score #AcidRain plate_havoc.event matches 1.. run return run function plate_havoc:game/events/restart with storage plate_havoc

scoreboard players set #AcidRain plate_havoc.event 15
weather rain
