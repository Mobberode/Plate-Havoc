execute if score #EggRain plate_havoc.event matches 1.. run return run function plate_havoc:game/events/restart with storage plate_havoc

tellraw @a [{text:"Eggs will rain across the plate for 25 seconds",color:gray}]
scoreboard players set #EggRain plate_havoc.event 125
