...
execute if score #Value plate_havoc.gamestatus matches 2.. if score #FireRain plate_havoc.event matches 1.. run return run schedule function plate_havoc:events/multi_sequence/fire_rain/loop 2s
