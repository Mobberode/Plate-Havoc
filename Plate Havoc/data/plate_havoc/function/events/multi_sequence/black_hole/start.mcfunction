...
execute at @n[type=marker,tag=plate_havoc.event_place] run summon item_display ~ ~ ~ {item:{id:"black_concrete"},transformation:{scale:[2.5,2.5,2.5],translation:[0,0,0],left_rotation:[0,0,0,1],right_rotation:[0,0,0,1]},Tags:["plate_havoc.blackhole"]}
