...
execute as @e[dy=0.2,type=!#plate_havoc:noncollidable] positioned ~-1 ~-1 ~-1 if entity @s[dy=0.2] unless entity @s[type=player,gamemode=spectator] run damage @s 7.5
tp @s ^ ^ ^.25
