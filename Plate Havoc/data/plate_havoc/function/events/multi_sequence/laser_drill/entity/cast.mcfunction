...
playsound block.beacon.deactivate hostile @a ~ ~ ~ 2 1 1

execute if score @s plate_havoc.num matches 10.. run function plate_havoc:events/multi_sequence/laser_drill/entity/destroy
