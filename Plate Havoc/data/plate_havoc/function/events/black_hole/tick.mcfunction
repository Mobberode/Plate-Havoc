...
function plate_havoc:events/black_hole/entity/update_size

function plate_havoc:events/black_hole/entity/move
function plate_havoc:events/black_hole/entity/pos
...
function plate_havoc:events/black_hole/entity/action with storage plate_havoc:events
