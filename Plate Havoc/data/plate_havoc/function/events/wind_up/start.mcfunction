...
execute if score #Wind_Up.Summon_Amount plate_havoc.event matches 1.. run return run function plate_havoc:events/wind_up/extend
...
function plate_havoc:events/wind_up/loop