...
execute if score #ObamaDroneStrike.Summon plate_havoc.event matches 1.. run return run function plate_havoc:events/zzz_console/obama_drone_strike/extend
...
function plate_havoc:events/zzz_console/obama_drone_strike/run