...
execute unless score #EventRunCount plate_havoc.num >= #Template.Event.Frail_Stairs.MaxRunCount plate_havoc.num run function plate_havoc:events/frail_stairs/run