...
execute unless score #EventRunCount plate_havoc.num >= #Template.Event.Spinning_Laser.MaxRunCount plate_havoc.num run function plate_havoc:events/spinning_laser/run