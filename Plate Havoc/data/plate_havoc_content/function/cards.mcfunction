...
\
{id:"plate_havoc_content:octagonal_move_normalizer",name:"Octagonal Move Normalizer",type:"plate_havoc_content:upgrade",cost:{base:25},requirement:[{type:cycle,value:7},{type:card,needed:[{id:"plate_havoc_content:swift_feets",count:3}]}],description:"+0.4 Movement efficiency, +15% Movement speed, *2 Water movement efficiency. -33% Fall damage, +0.5 Step height and +0.15 Sneaking speed.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/octagonal_move_normalizer/start"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:triple_jump",name:"Triple Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:10},{type:card,needed:[{id:"plate_havoc_content:double_jump"}]}],cost:{base:25},description:["Gives an additional jump. Press"," [",{keybind:"key.jump"},"] ","while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:chargers_medallion",name:"Chargers Medallion",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:3}],description:"Charge gain is doubled and loss is lessened by a quarter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/chargers_medallion/one_time"}],duration:1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:bouncier_pads",name:"Bouncier Pads",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:cycle,value:10}],description:"Bounce Pads get larger with slightly increased vertical boost. Some Bounce Pads spawn at the start of the cycle.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/bouncier_pads/one_time"},{type:on.start,function:"plate_havoc_content:cards/bouncier_pads/start"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:shock_absorber",name:"Shock Absorber",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:7},{type:advancement,value:"plate_havoc_content:charged_charred"}],description:"Getting hit by an lightning strike fully recharges ability and heavily increases Attack Damage for 10 seconds.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/shock_absorber/loop"}],duration:-1,left:1,max:1}},\
\
