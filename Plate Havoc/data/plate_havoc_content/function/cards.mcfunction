...
\
{id:"plate_havoc_content:swift_feets",name:"Swift Feets",type:"plate_havoc_content:upgrade",cost:{base:2,scale:2.5},description:"+10% Movement speed and +0.08 Water movement efficiency. (Max: 3)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/swift_feets/start"}],duration:-1,left:3,max:3}},\
\
{id:"plate_havoc_content:hearty",name:"Hearty",type:"plate_havoc_content:upgrade",cost:{base:7.5,solo:4,scale:1.75},description:"+2.5 Max hearts. (Max: 4)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/hearty/start"}],duration:-1,left:4,max:6}},\
\
...
\
{id:"plate_havoc_content:vampiristic_lifeblood",name:"Vampiristic Lifeblood",type:"plate_havoc_content:upgrade",cost:{base:80,solo:60},requirement:[{type:cycle,value:10}],description:"+10 Max hearts. Killing mobs restores a portion of health.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/vampiristic_lifeblood/start"},{type:loop,function:"plate_havoc_content:cards/vampiristic_lifeblood/loop"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:purified_hourglass",name:"Purified Hourglass",type:"plate_havoc_content:upgrade",cost:{base:150},requirement:[{type:card,needed:[{id:"plate_havoc_content:cursed_clocks"}]}],description:"Collecting Clocks slightly delay the Event Timer and removes 1/5 of Clock Spawn Time. Cursed Clocks delay even longer and adds to Cranked Time, halved penalty.",on_select:{functions:[{type:on.clock.collect,function:"plate_havoc_content:cards/purified_hourglass/collect"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:spy_shine",name:"Spy Shine",type:"plate_havoc_content:upgrade",cost:{base:250},requirement:[{type:cycle,value:15}],description:["[",{keybind:"key.attack"},"] ","to Shoot (Long cooldown on miss. +1 Boost (Uncapped) on hit."," [",{keybind:"use"},"] ","to Boost (Goes backwards. Hold to increase power (+4% per tick, capped to 300%)). Shooting affects only hostiles."],on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/spy_shine/give"},{type:player_loop,function:"plate_havoc_content:cards/spy_shine/loop"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:enraged",name:"Enraged",type:"plate_havoc_content:curse",exclusive:[{id:"plate_havoc_content:slow_passing"}],description:"Risker curses increase Cyclathron yield. *0.875 Time, *1.65 Intensity Gain. Events more aggressive but 12.5% shorter. Locks Slow Passing.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/enraged/one_time"},{type:on.start,function:"plate_havoc_content:cards/enraged/start"}],duration:-1,left:1,max:1}},\
\
