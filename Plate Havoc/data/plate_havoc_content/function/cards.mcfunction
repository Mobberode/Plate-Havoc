...
{id:"plate_havoc_content:iron_clock",name:{translate:"plate_havoc_content:card.iron_clock.name",fallback:"Iron Clock"},type:"plate_havoc_content:upgrade",cost:{base:5},description:{translate:"plate_havoc_content:card.iron_clock.description",fallback:"+0.15 Cyclathron yield."},on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/iron_clock/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:chilled_temper",name:"Chilled Temper",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:card,needed:[{id:"plate_havoc_content:enraged"}]}],description:"-15% Intensity Gain and -20% Intensity Scaling.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/chilled_temper/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:swift_feets",name:"Swift Feets",type:"plate_havoc_content:upgrade",cost:{base:2,scale:2},description:"+10% Movement speed and +0.12 Water movement efficiency. (Max: 3)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/swift_feets/start"}],duration:-1,left:3,max:3}},\
\
{id:"plate_havoc_content:hearty",name:"Hearty",type:"plate_havoc_content:upgrade",cost:{base:5,solo:3,scale:1.5},description:"+1.25 Max hearts. (Max: 4)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/hearty/start"}],duration:-1,left:4,max:6}},\
\
{id:"plate_havoc_content:armoured_up",name:"Armoured Up",type:"plate_havoc_content:upgrade",cost:{base:5,solo:4,scale:1.2},description:"+1 Armour and +0.5 Armour toughness. (Max: 5)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/armoured_up/start"}],duration:-1,left:5,max:6}},\
\
{id:"plate_havoc_content:strength_training",name:"Strength Training",type:"plate_havoc_content:upgrade",cost:{base:5,scale:1.5},requirement:[{type:cycle,value:3}],description:"+1.5 Attack damage and +0.2 Knockback resistance. (Max: 3)",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/strength_training/start"}],duration:1,left:3,max:4}},\
\
...
\
{id:"plate_havoc_content:multi_use_umbrella",name:"Multi-Use Umbrella",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:3}],description:"Shear when cobwebbed for 1s. 15s immunity to Acid Rain. Splashers activate for 5s with a 1m cooldown when on fire, extinguishing flames.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/multi_use_umbrella/loop"},{type:set.attribute,function:"plate_havoc_content:cards/multi_use_umbrella/set_player"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:hands_of_creativity",name:"Hands of Creativity",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:cycle,value:5}],description:"Gain the ability to Break, Place and Interact with blocks.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/hands_of_creativity/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:box_of_meats",name:"Box of Meats",type:"plate_havoc_content:upgrade",cost:{base:12.5},requirement:[{type:cycle,value:5}],description:"Gain 3 Cooked Mutton upon the start of a Cycle.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/box_of_meats/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:intense_investment",name:"Intense Investment",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:5}],exclusive:{values:[{id:"plate_havoc_content:blood_money"},{id:"plate_havoc_content:midas_touch"}]},description:"Converts 15% of Intensity gained from the current cycle and doubles it into Cyclathrons.",on_select:{functions:[{type:on.end,function:"plate_havoc_content:cards/intense_investment/end"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:diamond_clock",name:"Diamond Clock",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:card,needed:[{id:"plate_havoc_content:iron_clock"}]},{type:cycle,value:5}],description:"+0.15 Cyclathron yield and +0.5 Time Reduction from Clocks.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/diamond_clock/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:determination",name:"Determination",type:"plate_havoc_content:upgrade",cost:{base:15,solo:25},requirement:[{type:cycle,value:5}],description:"Upon Last Stand, receive minor stat improvements and any additional benefits. Becomes more powerful on solo.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/determination/start"},{type:on.last_alive,function:"plate_havoc_content:cards/determination/last_alive"},{type:on.end,function:"plate_havoc_content:cards/determination/end"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:fire_guardian",name:"Fire Guardian for Hire",type:"plate_havoc_content:upgrade",cost:{base:12.5},requirement:[{type:cycle,value:7}],description:"Flame Guardian protects all players, shooting flame projectiles towards hostiles that no longer ignite blocks.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/fire_guardian/one_time"},{type:on.start,function:"plate_havoc_content:cards/fire_guardian/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:boxless_desires",name:"Boxless Desires",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:card,needed:[{id:"plate_havoc_content:box_of_meats",count:1},{id:"plate_havoc_content:box_of_wind"}]},{type:cycle,value:7}],description:"Gain 3 Wind Charges and 2 Cooked Muttons upon the start of a cycle. Gain 2 Wind Charges and 1 Cooked Mutton every 30s during the cycle. Item events 50% more valuable.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/boxless_desires/start"},{type:loop,function:"plate_havoc_content:cards/boxless_desires/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:vampiristic_lifeblood",name:"Vampiristic Lifeblood",type:"plate_havoc_content:upgrade",cost:{base:25,solo:15},requirement:[{type:cycle,value:10}],description:"+5 Max hearts. Killing mobs restores a portion of health.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/vampiristic_lifeblood/attributes"},{type:loop,function:"plate_havoc_content:cards/vampiristic_lifeblood/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:gods_hand",name:"God's Hand",type:"plate_havoc_content:upgrade",cost:{base:25},requirement:[{type:cycle,value:10},{type:card,needed:[{id:"plate_havoc_content:hands_of_creativity"}]}],description:"Double Mining speed, +1 Interaction range. Blocks and mob loot now drops.",on_select:{duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:glacier_player",name:"Glacier Player",type:"plate_havoc_content:upgrade",cost:{base:75,solo:50},requirement:[{type:cycle,value:15}],description:"Revives a random player if there are none alive and gets consumed for the cycle.",on_select:{functions:[{type:prevent_end,function:"plate_havoc_content:cards/glacier_player/activate"},{type:on.start,function:"plate_havoc_content:cards/glacier_player/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:void_rift",name:"Void Rift",type:"plate_havoc_content:upgrade",cost:{base:25,solo:15},requirement:[{type:cycle,value:10}],description:"Falling to the Void teleports you back to the surface.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/void_rift/start"},{type:loop,function:"plate_havoc_content:cards/void_rift/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:netherite_clock",name:"Netherite Clock",type:"plate_havoc_content:upgrade",cost:{base:30},requirement:[{type:card,needed:[{id:"plate_havoc_content:diamond_clock"}]},{type:cycle,value:10}],description:"+0.2 Cyclathron yield, +1 Time Reduction from Clocks. Events last 10% shorter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/netherite_clock/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:healing_clock",name:"Healing Infused Clock",type:"plate_havoc_content:upgrade",cost:{base:100,scale:1.5,solo:60},requirement:[{type:cycle,value:15}],description:"Collecting Clocks restores a portion of health.",on_select:{functions:[{type:on.clock.collect,function:"plate_havoc_content:cards/healing_clock/collect"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:mechanical_extender",name:"Mechanical Extender",type:"plate_havoc_content:upgrade",cost:{base:8,scale:1.5},requirement:[{type:cycle,value:12}],description:"+0.5 Interaction range. +0.375 Clock collection range. (Max: 3)",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/mechanical_extender/start"},{type:set.attribute,function:"plate_havoc_content:cards/mechanical_extender/set_attribute"}],duration:-1,left:3,max:3}},\
\
{id:"plate_havoc_content:gravity_coil",name:"Gravity Coil",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:10}],description:["+10% Jump Strength, slightly lowered gravity. Hold"," ",{keybind:"key.jump",color:green,extra:[" "]},"to decrease gravity further."],on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/gravity_coil/set_attribute"},{type:player_loop,function:"plate_havoc_content:cards/gravity_coil/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:material_kit",name:"Material Kit",type:"plate_havoc_content:upgrade",cost:{base:5},requirement:[{type:card,needed:[{id:"plate_havoc_content:hands_of_creativity"}]}],description:"Supply some building blocks upon the start of a Cycle.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/material_kit/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:splitting_clocks",name:"Splitting Clocks",type:"plate_havoc_content:upgrade",cost:{base:30,scale:1.33},requirement:[{type:cycle,value:7},{type:card,needed:[{id:"plate_havoc_content:meagre_clocks"}]}],description:"+1 Clock Spawn Count. *1.33 (*1.5 on 2nd stack) Clock Spawn Time. (Max: 2)",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/double_clock/one_time"},{type:on.clock.spawn,function:"plate_havoc_content:cards/double_clock/spawn"}],duration:-1,left:2,max:1}},\
\
...
\
{id:"plate_havoc_content:hostile_radar_module",name:"Hostile Radar",type:"plate_havoc_content:upgrade",cost:{base:7.5},requirement:[{type:card,needed:[{id:"plate_havoc_content:rising_undead",count:1},{id:"plate_havoc_content:diamond_clock"}]}],description:"Every 10 seconds, highlight all non-marked hostile mobs.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/radar/hostile/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:critical_rollback",name:"Critical Rollback",type:"plate_havoc_content:upgrade",cost:{base:30,solo:20,scale:1.5},requirement:[{type:cycle,value:10}],description:"Blocks damage that would've killed regardless of health. (Max: 2)",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/critical_rollback/start"},{type:set.attribute,function:"plate_havoc_content:cards/critical_rollback/set"}],duration:-1,left:2,max:2}},\
\
{id:"plate_havoc_content:double_jump",name:"Double Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:3}],cost:{base:12.5},description:["Gives an additional jump. Press"," ",{keybind:"key.jump",color:green,extra:[" "]},"while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:triple_jump",name:"Triple Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:7},{type:card,needed:[{id:"plate_havoc_content:double_jump"}]}],cost:{base:15},description:["Gives an additional jump. Press"," ",{keybind:"key.jump",color:green,extra:[" "]},"while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:777_machine",name:"Triple 7 Machine",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:cycle,value:7}],description:"A random positive status effect is given to all players for a minute upon the start of a cycle.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/777_machine/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:temporal_manipulation",name:"Temporal Manipulation",type:"plate_havoc_content:upgrade",cost:{base:100},requirement:[{type:cycle,value:20}],description:"For the first 25 seconds of the cycle, Clocks spawn twice as fast and +80% Event Time with some time stats being affected.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/temporal_manipulation/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:bouncier_pads",name:"Bouncier Pads",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:7}],description:"More larger and stronger Bounce Pads that spawn from the start.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/bouncier_pads/one_time"},{type:on.start,function:"plate_havoc_content:cards/bouncier_pads/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:purified_hourglass",name:"Purified Hourglass",type:"plate_havoc_content:upgrade",cost:{base:75},requirement:[{type:card,needed:[{id:"plate_havoc_content:cursed_clocks"}]}],description:"Collecting Clocks slightly delay the Event Timer and removes 1/5 of Clock Spawn Time. Cursed Clocks delay even longer and adds to Cranked Time.",on_select:{functions:[{type:on.clock.collect,function:"plate_havoc_content:cards/purified_hourglass/collect"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:spy_shine",name:"Spy Shine",type:"plate_havoc_content:upgrade",cost:{base:50},requirement:[{type:cycle,value:15}],description:["",{keybind:"key.attack",color:green,extra:[" "]},"to Shoot (Long cooldown on miss. +1 Boost (Uncapped) on hit."," ",{keybind:"key.use",color:green,extra:[" "]},"to Boost (Goes backwards. Hold to increase power (+4% per tick, capped to 300%)). Shooting affects only hostiles."],on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/spy_shine/give"},{type:player_loop,function:"plate_havoc_content:cards/spy_shine/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:shock_absorber",name:"Shock Absorber",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:7},{type:advancement,value:"plate_havoc_content:charged_charred"}],description:"When struck by lightning, collect nearby Clocks and increase Attack damage by 1.33x for 10 seconds.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/shock_absorber/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:mechanical_heart",name:"Mechanical Heart",type:"plate_havoc_content:upgrade",cost:{base:25},requirement:[{type:cycle,value:7},{type:advancement,value:"plate_havoc_content:wasnt_enough"}],description:"Being under 20% health removes an additional tick from the Cycle time and Clock spawn time on odd ticks (Stackable).",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/mechanical_heart/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:blood_money",name:"Blood Money",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:5}],exclusive:{values:[{id:"plate_havoc_content:intense_investment"},{id:"plate_havoc_content:midas_touch"},{id:"plate_havoc_content:fire_guardian"}]},description:"Melee hits yield Cyclathrons from damage dealt to an entity. Accumulated damage permanently increases Attack damage up to +2.5 max.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/blood_money/tick"},{type:one_time,function:"plate_havoc_content:cards/blood_money/one_time"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:midas_touch",name:"Midas Touch",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:50}],exclusive:{hidden:true,values:[{id:"plate_havoc_content:intense_investment"},{id:"plate_havoc_content:blood_money"}]},description:"Usage of an Artefact increases Cyclathron yield by 0.1 for the cycle.",on_select:{duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:nanomachines",name:"Nanomachines",type:"plate_havoc_content:upgrade",cost:{base:20,solo:12.5},requirement:[{type:cycle,value:7}],exclusive:{values:[{id:"plate_havoc_content:deflecting_barrier"}]},description:"Receiving 8 or more hearts of damage over 1.5 seconds doubles Armour for 8 seconds. Can be stacked for a longer duration.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/nanomachines/tick"},{type:set.attribute,function:"plate_havoc_content:cards/nanomachines/wipe"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:deflecting_barrier",name:"Deflecting Barrier",type:"plate_havoc_content:upgrade",cost:{base:30,solo:15},requirement:[{type:cycle,value:7}],exclusive:{values:[{id:"plate_havoc_content:nanomachines"}]},description:"Deflect some projectiles that are nearby, expending energy with some being more costly. Regenerates 30 seconds after breakage.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/deflecting_barrier/tick"},{type:set.attribute,function:"plate_havoc_content:cards/deflecting_barrier/ready"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:weight_scaler",name:"Weight Scaler",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:5}],description:"Attack speed is increased the lower the hunger bar.",on_select:{functions:[{type:player_loop,function:"plate_havoc_content:cards/weight_scaler/tick"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:artetractor",name:"Arte-tractor",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:50}],description:"An additional Artefact now spawns.",on_select:{duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:roller_skates",name:"Roller Skates",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:10}],exclusive:{values:[{id:"plate_havoc_content:jet_boots"}]},description:"Build speed with no friction and enhanced sprint jumps. Sneak to stop. +0.75 Movement efficiency and 2x Step height.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/roller_skates/set_attribute"},{type:"player_loop",function:"plate_havoc_content:cards/roller_skates/tick"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:jet_boots",name:"Jet Boots",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:10},{type:card,needed:[{id:"plate_havoc_content:triple_jump"}]}],exclusive:{values:[{id:"plate_havoc_content:roller_skates"}]},description:"Gain an additional, more powerful jump that goes in the direction you're facing, reach dependent on speed. -33% Fall damage.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/jet_boots/set_attribute"},{type:one_time,function:"plate_havoc_content:cards/jet_boots/one_time"}]}},\
\
{id:"plate_havoc_content:emergency_pads",name:"Emergency Pads",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:12},{type:card,needed:[{id:"plate_havoc_content:bouncier_pads"}]}],description:"More sparse, lesser, more powerful Bounce Pads that spawn just above Void height.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/bouncier_pads/emergency"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:tailsman_of_hope",name:"Tailsman of Hope",type:"plate_havoc_content:upgrade",cost:{base:12.5},requirement:[{type:cycle,value:12}],description:"Guarantee a positive Event every 30th Events.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/tailsman_of_hope/on_start"},{type:on.action,function:"plate_havoc_content:cards/tailsman_of_hope/on_action"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:sapper",name:"Sapper",type:"plate_havoc_content:upgrade",cost:{base:7.5,scale:2},requirement:[{type:cycle,value:7}],description:"10% chance to entirely disable several hazards (Proximity Mines) or lessen more dangerous threats (Max: 20%).",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/sapper/on_start"}],duration:-1,left:2,max:2}},\
\
{id:"plate_havoc_content:suction_cups",name:"Suction Cups",type:"plate_havoc_content:upgrade",cost:{base:25},requirement:[{type:cycle,value:12}],description:["Bumping into a wall whilst holding"," ",{keybind:key.forward,color:green,extra:[" "]},"and"," ",{keybind:key.sneak,color:green,extra:[" "]},"sends you back slightly and converts momentum into height."],on_select:{functions:[{type:"player_loop",function:"plate_havoc_content:cards/suction_cups/tick"}],duration:-1,left:1,max:1}},\
\
...
\
\
{id:"plate_havoc_content:piranha_season",name:"Piranha Season",type:"plate_havoc_content:curse",reward:{base:10},description:"Piranhas infest water, dealing 1.5x damage",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/piranha_season/start"}],duration:-1,left:1,max:1,value:0.5}},\
\
{id:"plate_havoc_content:enraged",name:"Enraged",type:"plate_havoc_content:curse",exclusive:{values:[{id:"plate_havoc_content:slow_passing"}]},description:"Clocks have increased value but decreases overtime, down to half their max value. *0.9 Time, *1.33 Intensity Gain. Events more aggressive but 20% shorter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/enraged/one_time"},{type:on.clock.init,function:"plate_havoc_content:cards/enraged/init"},{type:on.clock.spawn,function:"plate_havoc_content:cards/enraged/spawn"},{type:on.clock.tick,function:"plate_havoc_content:cards/enraged/tick"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:cursed_clocks",name:"Cursed Clocks",type:"plate_havoc_content:curse",reward:{base:20},requirement:[{type:cycle,value:5}],description:"Every fourth Clock becomes cursed, easily identifiable. Yields no Cyclathrons and damages. Increases Time but also Event Timer. Transmits to nearby non-cursed Clocks, faster with additional cursed clocks.",on_select:{functions:[{type:on.clock.spawn,function:"plate_havoc_content:cards/cursed_clocks/spawn"},{type:on.clock.collect,function:"plate_havoc_content:cards/cursed_clocks/collect"},{type:loop,function:"plate_havoc_content:cards/cursed_clocks/loop"}],duration:-1,left:1,max:1,value:1}},\
\
{id:"plate_havoc_content:new_years",name:"New Years",type:"plate_havoc_content:curse",reward:{base:10,scale:1.5},requirement:[{type:cycle,value:3}],description:"Fireworks are guaranteed at the start and spawn 25% (Max: 50%) more fireworks. Faster on second stack.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/new_years/start"}],duration:-1,left:2,max:1,value:0.25}},\
\
...
\
{id:"plate_havoc_content:slow_passing",name:"Slow Passing",type:"plate_havoc_content:curse",exclusive:{values:[{id:"plate_havoc_content:enraged"}]},description:"Clocks have decreased value but become ripe overtime, up to triple their max value. Waiting too long quickly rots their value down to 20%. More time, longer durations.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/slow_passing/start"},{type:on.clock.init,function:"plate_havoc_content:cards/slow_passing/init"},{type:on.clock.spawn,function:"plate_havoc_content:cards/slow_passing/spawn"},{type:on.clock.tick,function:"plate_havoc_content:cards/slow_passing/tick"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:putrid_stink",name:"Putrid Stink",type:"plate_havoc_content:curse",reward:10,requirement:[{type:cycle,value:7}],description:"Being near Zombies inflicts Poison.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/putrid_stink/loop"}],duration:-1,left:1,max:1,value:0.5}},\
\
...
\
{id:"plate_havoc_content:electrified_rod",name:"Electrified Rod",type:"plate_havoc_content:curse",reward:{base:20},requirement:[{type:cycle,value:5}],description:"Lightning Bolts chain to nearby mobs and Creepers spawn charged with increased stats.",on_select:{functions:[{type:on.mob_setup,function:"plate_havoc_content:cards/electrified_rod/mob_setup"}],duration:-1,left:1,max:1,value:0.75}},\
\
{id:"plate_havoc_content:task_manager",name:"Task Manager",type:"plate_havoc_content:curse",reward:{base:20},requirement:[{type:cycle,value:150}],description:"Assigns tasks during the cycle that must be completed.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/task_manager/start"},{type:loop,function:"plate_havoc_content:cards/task_manager/loop"}],duration:-1,left:1,max:1,value:1.25}},\
\
...
\
{id:"plate_havoc_content:pausing_gaze",name:"Pausing Gaze",type:"plate_havoc_content:curse",reward:{base:25},requirement:[{type:intensity,event:"plate_havoc_content:gazing_shadow"}],description:"Gazing Shadow pauses the time during it's presence but lasts 40% shorter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/pausing_gaze/one_time"}],duration:-1,left:1,max:1,value:1.25}},\
\
{id:"plate_havoc_content:lasting_acid",name:"Lasting Acid",type:"plate_havoc_content:curse",reward:{base:15},requirement:[{type:intensity,event:"plate_havoc_content:acid_rain"}],description:"Acid sticks for 10 seconds upon contact. Wash it away with water.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/lasting_acid/loop"}],duration:-1,left:1,max:1,value:0.8}},\
\
...
\
{id:"plate_havoc_content:void_pull",name:"Void Pull",type:"plate_havoc_content:deeper_curse",description:"The Void pulls down those who stay airborne. 1.5x Fall Damage and increased Void damage.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/void_pull/loop"},{type:set.attribute,function:"plate_havoc_content:cards/void_pull/set_attribute"},{type:one_time,function:"plate_havoc_content:cards/void_pull/one_time"}],duration:-1,left:1,max:1,value:0.5}},\
\
...
\
{id:"plate_havoc_content:shulker_rf",name:"Shulker Tactics: Rapid Fire",type:"plate_havoc_content:chaos",description:"X formation of Shulker Bullets are shot every second. GG!",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/shulker_x/chaos_rf"}],duration:-1,left:1,max:1,value:10}},\
\
