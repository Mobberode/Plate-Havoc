...
{id:"plate_havoc_content:iron_clock",name:"Iron Clock",type:"plate_havoc_content:upgrade",cost:{base:5},description:"+0.75 Cyclathron Yield and Event Time is increased by 15%",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/iron_clock/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:chilled_temper",name:"Chilled Temper",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:card,needed:[{id:"plate_havoc_content:enraged",count:1}]}],description:"-15% Intensity Gain and -20% Intensity Scaling.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/chilled_temper/start"}],duration:1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:multi_use_umbrella",name:"Multi-Use Umbrella",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:cycle,value:3}],description:"Shears Cobwebs and Acid Rain immunity for 15 seconds when exposed. Splashers activate for 5 seconds when on fire, extinguishing flames. 1 minute cooldown.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/multi_use_umbrella/loop"},{type:set.attribute,function:"plate_havoc_content:cards/multi_use_umbrella/set_player"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:hands_of_creativity",name:"Hands of Creativity",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:5}],description:"Gain the ability to Break, Place and Interact with blocks.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/hands_of_creativity/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:box_of_meats",name:"Box of Meats",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:cycle,value:5}],description:"Players are given 3 Cooked Mutton at the start of every Cycle.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/box_of_meats/start"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:diamond_clock",name:"Diamond Clock",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:card,needed:[{id:"plate_havoc_content:iron_clock",count:1}]},{type:cycle,value:5}],description:"+1 Cyclathron Yield and +1 Time Reduction upon clock collect.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/diamond_clock/start"}],duration:1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:netherite_clock",name:"Netherite Clock",type:"plate_havoc_content:upgrade",cost:{base:50},requirement:[{type:card,needed:[{id:"plate_havoc_content:diamond_clock",count:1}]},{type:cycle,value:10}],description:"+1.25 Cyclathron Yield and +2 Time Reduction upon clock collect. Duration of events are 10% shorter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/netherite_clock/start"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:healing_clock",name:"Healing Infused Clock",type:"plate_havoc_content:upgrade",cost:{base:150,scale:3,solo:100},requirement:[{type:cycle,value:15}],description:"Collecting Clocks restores bits of the collector's health.",on_select:{functions:[{type:on.clock.collect,function:"plate_havoc_content:cards/healing_clock/collect"}],duration:-1,left:2,max:2}},\
\
{id:"plate_havoc_content:mechanical_extender",name:"Mechanical Extender",type:"plate_havoc_content:upgrade",cost:{base:15,scale:1.5},requirement:[{type:cycle,value:12}],description:"Increase the range that players can interact with blocks and entities by +(0.5 *Stack) Also increases the range of Clocks by +(0.25 *Stack) (Max: 3)",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/mechanical_extender/start"},{type:set.attribute,function:"plate_havoc_content:cards/mechanical_extender/set_attribute"}],duration:-1,left:3,max:3}},\
\
...
\
{id:"plate_havoc_content:material_kit",name:"Material Kit",type:"plate_havoc_content:upgrade",cost:{base:15},requirement:[{type:card,needed:[{id:"plate_havoc_content:hands_of_creativity",count:1}]}],description:"Supplies each player with some building blocks.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/material_kit/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:double_clock",name:"Splitting Clocks",type:"plate_havoc_content:upgrade",cost:{base:50,scale:4},requirement:[{type:cycle,value:7},{type:card,needed:[{id:"plate_havoc_content:meagre_clocks",count:1}]}],description:"+(1 *Stack) Clock Spawns. *1.33(*1.5 on 2nd stack) Clock Spawn Time",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/double_clock/one_time"},{type:on.clock.spawn,function:"plate_havoc_content:cards/double_clock/spawn"}],duration:-1,left:2,max:1}},\
\
{id:"plate_havoc_content:player_radar_module",name:"Player Radar",type:"plate_havoc_content:upgrade",requirement:[{type:card,needed:[{id:"plate_havoc_content:diamond_clock",count:1}]}],description:"Players are now highlighted.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/radar/player/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:hostile_radar_module",name:"Hostile Radar",type:"plate_havoc_content:upgrade",requirement:[{type:card,needed:[{id:"plate_havoc_content:rising_undead",count:1},{id:"plate_havoc_content:diamond_clock",count:1}]}],description:"Hostile entities are highlighted for 5 seconds, every 30 seconds.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/radar/hostile/loop"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:critical_rollback",name:"Critical Rollback",type:"plate_havoc_content:upgrade",cost:{base:60,scale:1.75},requirement:[{type:cycle,value:10}],description:"Blocks an instakillable instance of damage. (Max: 2)",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/critical_rollback/start"},{type:set.attribute,function:"plate_havoc_content:cards/critical_rollback/set"}],duration:-1,left:2,max:2}},\
\
...
\
{id:"plate_havoc_content:triple_jump",name:"Triple Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:10},{type:card,needed:[{id:"plate_havoc_content:double_jump",count:1}]}],cost:{base:30},description:["Gives an additional jump. Press [",{keybind:"key.jump"},"] while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:chargers_medallion",name:"Chargers Medallion",type:"plate_havoc_content:upgrade",cost:{base:10},requirement:[{type:cycle,value:3}],description:"When charging, gain is doubled and loss is lessened by a quarter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/chargers_medallion/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:777_machine",name:"Triple 7 Machine",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:7}],description:"A random positive status effect that lasts for a minute will be given to all players upon the start of the cycle.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/777_machine/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:temporal_manipulation",name:"Temporal Manipulation",type:"plate_havoc_content:upgrade",cost:{base:250},requirement:[{type:cycle,value:15}],description:"For the first 25 seconds of the cycle, clocks spawn twice as fast and the event timer is 80% slower. Certain timed elements are also affected.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/temporal_manipulation/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:real_wings",name:"Real Wings",type:"plate_havoc_content:upgrade",cost:1000000,requirement:[{type:cycle,value:30}],description:["Dont fly too close to the sun. Infinite flight and complete fall damage immunity. Hold [",{keybind:"key.jump"},"] to fly."],on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/real_wings/set"},{type:loop,function:"plate_havoc_content:cards/real_wings/loop"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:purified_hourglass",name:"Purified Hourglass",type:"plate_havoc_content:upgrade",cost:{base:150},requirement:[{type:card,needed:[{id:"plate_havoc_content:cursed_clocks",count:1}]}],description:"Collecting non-cursed Clocks slightly delay the Event Timer and cursed Clocks delay even longer and adds to Cranked Time. Clocks reduce 1/5 of Clock Spawn Time. Time penalty halved.",on_select:{functions:[{type:on.clock.collect,function:"plate_havoc_content:cards/purified_hourglass/collect"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:spy_shine",name:"Spy Shine",type:"plate_havoc_content:upgrade",cost:{base:150},requirement:[{type:cycle,value:150}],description:"LMB to Shoot (Long cooldown on miss. +1 Boost (Uncapped) on hit. RMB to Boost (Goes backwards. Hold to increase power (+4% per tick, capped to 300%))",on_select:{functions:[],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:mechanical_heart",name:"Mechanical Heart",type:"plate_havoc_content:upgrade",cost:{base:40,solo:20},requirement:[{type:cycle,value:70},{type:advancement,value:"plate_havoc_content:wasnt_enough"}],description:"Prevents a Game Over and continues ticking the timer for 2.5 seconds.",on_select:{functions:[],duration:-1,left:1,max:1}},\
\
\
\
{id:"plate_havoc_content:piranha_season",name:"Piranha Season",type:"plate_havoc_content:curse",reward:{base:15},description:"Piranhas constantly infest water, dealing 1.75x damage. Piranhas remain twice as long out of water.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/piranha_season/start"}],duration:-1,left:1,max:1,value:0.5}},\
\
{id:"plate_havoc_content:enraged",name:"Enraged",type:"plate_havoc_content:curse",exclusive:[{id:"plate_havoc_content:slow_passing"}],description:"Risker curses benefit Cyclathron Yield. *0.875 Time but *1.65 Intensity Gain and Events last 12.5% shorter but are more agressive. Slow Passing unavailable if picked.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/enraged/one_time"},{type:on.start,function:"plate_havoc_content:cards/enraged/start"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:new_years",name:"New Years",type:"plate_havoc_content:curse",reward:{base:20,scale:2},requirement:[{type:cycle,value:3}],description:"Fireworks are guaranteed at the start and spawn 25% more fireworks. Replaced by a deadlier variant on second stack.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/new_years/start"},{type:one_time,function:"plate_havoc_content:cards/new_years/one_time"}],duration:-1,left:2,max:1,value:0.25}},\
\
{id:"plate_havoc_content:silverfestation",name:"Silverfestation",type:"plate_havoc_content:curse",description:"Every mob is given the Infestation status effect. Collecting Clocks have 15% chance of spawning a Silverfish.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/silverfestation/start"},{type:on.clock.collect,function:"plate_havoc_content:cards/silverfestation/clock_collect"}],duration:-1,left:1,max:1,value:0.1}},\
\
...
\
{id:"plate_havoc_content:hatred",name:"Hatred",type:"plate_havoc_content:curse",requirement:[{type:card,needed:[{id:"plate_havoc_content:enraged",count:1}]}],description:"-12.5% Event Time, +15% Intensity gain",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/hatred/start"}],duration:1,left:1,max:1,value:0.5}},\
\
{id:"plate_havoc_content:slow_passing",name:"Slow Passing",type:"plate_havoc_content:curse",exclusive:[{id:"plate_havoc_content:enraged"}],description:"*1.5 Cyclathrons upon cycle end but *1.33 Time and durations with nullified Cyclathron Yield. Enraged unavailable if selected.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/slow_passing/start"},{type:on.end,function:"plate_havoc_content:cards/slow_passing/end"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:rf_strike_pack",name:"RF Strike Pack",type:"plate_havoc_content:curse",requirement:[{type:cycle,value:7}],description:"Motion Snipers now rapidly fire. 2x Ammo and halved Damage to compenstate for increased rate of fire.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/rf_strike_pack/start"}],duration:1,left:1,max:1,value:0.2}},\
\
...
\
{id:"plate_havoc_content:putrid_stink",name:"Putrid Stink",type:"plate_havoc_content:curse",reward:20,requirement:[{type:cycle,value:7}],description:"Being near Zombies will poison you.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/putrid_stink/loop"}],duration:-1,left:1,max:1,value:0.5}},\
\
{id:"plate_havoc_content:rising_undead",name:"Rising Undead",type:"plate_havoc_content:curse",requirement:[{type:cycle,value:5}],description:"Undead mobs will spawn every 30 seconds.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/rising_undead/loop"}],duration:-1,left:1,max:1,value:0.25}},\
\
...
\
{id:"plate_havoc_content:risk_of_piranhas",name:"Risk of Piranhas",type:"plate_havoc_content:curse",reward:{base:50},requirement:[{type:cycle,value:10}],description:"Piranhas if active, bite when exposed to rain. Damage halved and longer bite times to compenstate.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/risk_or_piranhas/one_time"}],duration:-1,left:1,max:1,value:2.5}},\
\
{id:"plate_havoc_content:task_assigner",name:"Task Assigner",type:"plate_havoc_content:curse",reward:25,requirement:[{type:cycle,value:150}],description:"Assigns a global task to be met before the minute deadline. Assigns every 30s if there's no tasks.",on_select:{duration:-1,left:1,max:1,value:1.25}},\
\
...
\
{id:"plate_havoc_content:proximity_field",name:"Proximity Field",type:"plate_havoc_content:curse",requirement:[{type:cycle,value:7}],description:"Proximity Mines are scattered across the map. Triple the Porximity Mines spawn.",on_select:{functions:[{type:on.start,function:"plate_havoc_content:cards/proximity_field/start"}],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:withering_clock",name:"Withering Clock",type:"plate_havoc_content:curse",requirement:[{type:cycle,value:150}],description:"Clocks become less and less effective after a small amount of time, disappearing once all effectiveness is lost.",on_select:{functions:[],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:cracked_skull",name:"Cracked Skull",type:"plate_havoc_content:curse",requirement:[{type:cycle,value:100}],description:"Upon Last Stand or getting under 5% of max health on solo. Disable Clocks and force the time to 90s if below.",on_select:{functions:[],duration:-1,left:1,max:1}},\
\
{id:"plate_havoc_content:pausing_gaze",name:"Pausing Gaze",type:"plate_havoc_content:curse",reward:{base:50},requirement:[{type:intensity,event:"plate_havoc_content:gazing_shadow"}],description:"Gazing Shadow will pause the time during it's presence but lasts 40% shorter.",on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/pausing_gaze/one_time"}],duration:-1,left:1,max:1,value:1.25}},\
\
...
\
\
{id:"plate_havoc_content:fragile_void",name:"Fragility of the Void",type:"plate_havoc_content:deeper_curse",description:"Implosions start spawning, instakilling if inside. Amount spawned at once per-player (4 max on solo. Unlimited but halved on multiplayer.) depends on the cycle.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/fragile_void/loop"},{type:on.start,function:"plate_havoc_content:cards/fragile_void/start"}],duration:-1,left:1,max:1,value:0.65}},\
\
{id:"plate_havoc_content:void_pull",name:"Void Pull",type:"plate_havoc_content:deeper_curse",description:"The Void pulls down those who stay airborne and increases the Void's farther limit by 96 with increased damage. +15% Gravity and 1.75x Fall Damage.",on_select:{functions:[{type:loop,function:"plate_havoc_content:cards/void_pull/loop"},{type:set.attribute,function:"plate_havoc_content:cards/void_pull/set_attribute"},{type:one_time,function:"plate_havoc_content:cards/void_pull/one_time"}],duration:-1,left:1,max:1,value:0.5}},\
\
