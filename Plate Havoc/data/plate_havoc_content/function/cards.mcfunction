...
\
{id:"plate_havoc_content:double_jump",name:"Double Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:3}],cost:{base:12.5},description:["Gives an additional jump. Press"," [",{keybind:"key.jump"},"] ","while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
{id:"plate_havoc_content:triple_jump",name:"Triple Jump",type:"plate_havoc_content:upgrade",requirement:[{type:cycle,value:7},{type:card,needed:[{id:"plate_havoc_content:double_jump"}]}],cost:{base:15},description:["Gives an additional jump. Press"," [",{keybind:"key.jump"},"] ","while mid-air to Use."],on_select:{functions:[{type:one_time,function:"plate_havoc_content:cards/extra_jump/one_time"}],duration:1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:spy_shine",name:"Spy Shine",type:"plate_havoc_content:upgrade",cost:{base:50},requirement:[{type:cycle,value:15}],description:["[",{keybind:"key.attack"},"] ","to Shoot (Long cooldown on miss. +1 Boost (Uncapped) on hit."," [",{keybind:"key.use"},"] ","to Boost (Goes backwards. Hold to increase power (+4% per tick, capped to 300%)). Shooting affects only hostiles."],on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/spy_shine/give"},{type:player_loop,function:"plate_havoc_content:cards/spy_shine/loop"}],duration:-1,left:1,max:1}},\
\
...
\
{id:"plate_havoc_content:jet_boots",name:"Jet Boots",type:"plate_havoc_content:upgrade",cost:{base:20},requirement:[{type:cycle,value:10},{type:card,needed:[{id:"plate_havoc_content:double_jump"}]}],exclusive:{values:[{id:"plate_havoc_content:roller_skates"}]},description:"Gain an additional, more powerful jump that goes in the direction you're facing, reach dependent on speed. -33% Fall damage.",on_select:{functions:[{type:set.attribute,function:"plate_havoc_content:cards/jet_boots/set_attribute"},{type:one_time,function:"plate_havoc_content:cards/jet_boots/one_time"}]}},\
\
...
\
{id:"plate_havoc_content:suction_cups",name:"Suction Cups",type:"plate_havoc_content:upgrade",cost:{base:7.5,scale:2},requirement:[{type:cycle,value:120}],description:"Holding the forwards key and bumping into a wall sends you back slightly and converts momentum into height.",on_select:{duration:-1,left:2,max:2}},\
\
