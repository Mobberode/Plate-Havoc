...
data modify storage plate_havoc:temp temp set value {id:defeated_the_forgotten,translate:"plate_havoc_content:leaderboard.defeated_the_forgotten",fallback:"Defeated The Forgotten",extra:["?: ",{meta:value,color:yellow}]}
