data modify storage plate_havoc:temp temp_input set value {id:survivor,translate:"plate_havoc:shared.Survivor",fallback:"Survivor",extra:[": ",{meta:value,color:gold,hover_event:{action:"show_text",value:["","\n","\n\n"]}}]}
...
data modify storage plate_havoc:temp temp_input.extra[{meta:value}] merge from storage plate_havoc:survivors temp.output.name
execute unless data storage plate_havoc:survivors temp.output.name{} run data modify storage plate_havoc:temp temp_input.extra[{meta:value}].text set from storage plate_havoc:survivors temp.output.name
