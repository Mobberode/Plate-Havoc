...
data modify storage plate_havoc:temp temp_input set value {id:damage_dealt,translate:"plate_havoc_content:leaderboard.player.damage_dealt",fallback:"Damage Dealt",extra:[": ",{meta:value,color:red}]}
