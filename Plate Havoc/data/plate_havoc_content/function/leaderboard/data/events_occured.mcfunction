...
data modify storage plate_havoc:temp temp set value {id:events_occured,translate:"plate_havoc_content:leaderboard.events_occured",fallback:"Events Occured",extra:[": ",{meta:value,color:red}]}
