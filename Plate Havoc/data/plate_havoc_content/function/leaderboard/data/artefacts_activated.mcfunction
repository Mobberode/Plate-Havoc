...
data modify storage plate_havoc:temp temp set value {id:artefacts_activated,translate:"plate_havoc_content:leaderboard.artefacts_activated",fallback:"Artefacts Activated",extra:[": ",{meta:value,color:"#c3ff42"}]}
