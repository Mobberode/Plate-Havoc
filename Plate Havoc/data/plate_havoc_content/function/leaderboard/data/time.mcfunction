...
data modify storage plate_havoc:temp temp set value {id:elapsed_tine,translate:"plate_havoc_content:leaderboard.elapsed_time",fallback:"Elapsed Time",extra:[": ",{meta:value,color:gold},"s"]}
