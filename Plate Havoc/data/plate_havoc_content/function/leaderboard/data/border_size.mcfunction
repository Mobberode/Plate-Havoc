...
data modify storage plate_havoc:temp temp set value {id:border_size,translate:"plate_havoc_legacy_content:leaderboard.border_size",fallback:"Border Size",extra:[": ",{meta:value,color:aqua}]}
