...
data modify storage plate_havoc:temp temp set value {id:intensity_reached,translate:"plate_havoc_content:leaderboard.intensity_reached",fallback:"Intensity Reached",extra:[": ",{meta:value,color:red}]}
