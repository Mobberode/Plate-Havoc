...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:difficulty.eclipsed",value:-0.1,operation:"add_multiplied_total"}
