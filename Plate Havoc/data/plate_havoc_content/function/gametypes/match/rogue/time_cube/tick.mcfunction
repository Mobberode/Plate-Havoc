execute in plate_havoc:arena as @e[x=0,type=hovering_item_display,tag=plate_havoc_content.misc.clock] at @s run function plate_havoc_content:gametypes/match/rogue/time_cube/entity_tick
