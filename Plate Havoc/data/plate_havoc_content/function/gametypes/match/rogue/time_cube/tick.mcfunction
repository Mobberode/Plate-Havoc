execute as @e[type=item_display,tag=plate_havoc_content.misc.time_cube] at @s run function plate_havoc_content:gametypes/match/rogue/time_cube/entity_tick
