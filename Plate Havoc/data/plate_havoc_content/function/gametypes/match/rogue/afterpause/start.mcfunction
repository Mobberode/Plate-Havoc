...
scoreboard players operation #Max plate_havoc.timer = #Left plate_havoc.timer

function plate_havoc:game/misc/cards/attributes/after_pause/visual_process with storage plate_havoc:cards template
