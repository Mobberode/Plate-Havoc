execute in plate_havoc:arena as @e[x=0,type=item_display,tag=plate_havoc_content.misc.clock] at @s run function plate_havoc_content:gametypes/rogue/time_cube/entity_tick
