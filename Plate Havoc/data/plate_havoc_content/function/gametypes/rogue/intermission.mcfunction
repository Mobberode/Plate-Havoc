...
execute if score #Playing plate_havoc.status matches 0 unless score #Game plate_havoc.status matches 0 run schedule function plate_havoc_content:gametypes/rogue/intermission 1t