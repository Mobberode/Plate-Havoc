...
data modify storage plate_havoc:ui bar.global.snbt[{id:time}].extra[{meta:value}].color set value red
data modify storage plate_havoc:ui bar.global.snbt[{id:players}].extra set value [{text:"Players: "},{score:{name:"#Current",objective:plate_havoc.players},color:red},{text:"/"},{score:{name:"#Match",objective:plate_havoc.players},color:red}]
