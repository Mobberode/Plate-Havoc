...
data modify storage plate_havoc:data functions.set_plate set value "plate_havoc_content:gametypes/prematch/lava_rush/fill"
data modify storage plate_havoc:data functions.on_action set value "plate_havoc_content:gametypes/match/lava_rush/action"
