...
{id:upgrade,multiple_of:1,attributes:{multiple_selection:true,player_scaling:true,rerollable:{status:true,remove_cards:true,cost:{base:15,scale:false,retain_cost:false}},voting:{mode:votes,behaviour:{votes:{requirement_percentage:50,rounding:down},timed:{time:15}}}},colour:"green",name:{text:"UPGRADES"},sound_function:"plate_havoc_content:card_types/sfx_upgrade",metadata:{author:"Mobberode",pack:"Plate Havoc"}},\
\
