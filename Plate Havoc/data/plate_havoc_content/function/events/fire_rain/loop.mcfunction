...
execute if score #Playing plate_havoc.status matches 1.. if score #PHC.FireRain.Amount plate_havoc.event matches 1.. run return run schedule function plate_havoc_content:events/fire_rain/loop 1t
