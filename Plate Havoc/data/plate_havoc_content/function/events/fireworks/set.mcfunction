##Positioning
#
scoreboard players set #Modulo plate_havoc.temp 6
scoreboard players set #Modulo2 plate_havoc.temp -6
...
execute store result storage plate_havoc:events active_data.shared.distance int 1 run function plate_havoc:misc/prng_ranged
###
#
...
##Data
#
scoreboard players set #Modulo plate_havoc.temp 611
scoreboard players set #Modulo2 plate_havoc.temp 211
execute store result storage plate_havoc:events active_data.shared.life int 1 run function plate_havoc:misc/prng_ranged
#
scoreboard players set #Modulo plate_havoc.temp 76
scoreboard players set #Modulo2 plate_havoc.temp 21
execute store result storage plate_havoc:events active_data.shared.speed double 0.01 run function plate_havoc:misc/prng_ranged
