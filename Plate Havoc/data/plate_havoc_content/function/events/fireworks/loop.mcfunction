...
execute if score #Game plate_havoc.status matches 2.. if score #Fireworks.Summon plate_havoc.event matches 1.. run return run schedule function plate_havoc_content:events/fireworks/loop 1t
