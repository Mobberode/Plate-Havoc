...
execute unless score #Temp plate_havoc.temp matches 1 if data storage plate_havoc:data {run_tags:["eclipsed"]} run function plate_havoc_content:events/acid_rain/eclipsed/check
