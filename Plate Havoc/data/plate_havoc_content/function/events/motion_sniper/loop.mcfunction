...
execute if score #Motion_Sniper.CurrentDelay plate_havoc.event >= #Motion_Sniper.PhaseDelay plate_havoc.event run function plate_havoc_content:events/motion_sniper/phase_check

execute if score #Motion_Sniper.Phase plate_havoc.event matches 1 run function plate_havoc_content:events/motion_sniper/phase/warning
