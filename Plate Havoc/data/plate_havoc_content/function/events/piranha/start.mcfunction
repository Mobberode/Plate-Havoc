...
scoreboard players operation #Piranha.Duration plate_havoc.event *= #MaxRunCount plate_havoc.num

function plate_havoc_content:events/piranha/loop

data modify storage plate_havoc:ui temp set value {message:{text:"Piranhas are in the water.",color:red}}
