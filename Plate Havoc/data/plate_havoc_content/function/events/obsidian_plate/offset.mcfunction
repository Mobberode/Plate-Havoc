#X
scoreboard players operation #Modulo plate_havoc.temp = #XYZ plate_havoc.temp
scoreboard players operation #Modulo2 plate_havoc.temp = #XYZ plate_havoc.temp
...
function plate_havoc_content:events/obsidian_plate/position with storage plate_havoc:events active_data.shared