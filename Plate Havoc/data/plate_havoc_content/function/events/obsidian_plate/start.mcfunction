...
execute store result storage plate_havoc:events offset int 1 run data get storage plate_havoc:custom attributes[{id:"plate_havoc_content:event.obsidian_plate.offset"}].output 100
