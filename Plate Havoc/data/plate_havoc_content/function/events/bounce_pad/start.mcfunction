##Data
data modify storage plate_havoc:events temp set value {item:{id:blue_concrete,components:{enchantment_glint_override:true}},transformation:{scale:[3,0.25,3],translation:[0,0,0],left_rotation:[0,0,0,1],right_rotation:[0,0,0,1]},Tags:["plate_havoc_content.event.bounce_pad","plate_havoc_content.event.bounce_pad.blue","plate_havoc.dont_interact"]}
