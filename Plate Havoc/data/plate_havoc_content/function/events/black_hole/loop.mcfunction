...
execute in plate_havoc:arena as @e[x=0,tag=plate_havoc_content.event.blackhole,type=hovering_item_display] at @s run function plate_havoc_content:events/black_hole/entity/tick
