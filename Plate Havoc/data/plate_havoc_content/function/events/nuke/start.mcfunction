...
execute if score #Max plate_havoc.players matches ..1 store result storage plate_havoc:events active_data.plate_havoc_content.nuke.entity.power double 1 run data get storage plate_havoc:custom attributes[{id:"plate_havoc_content:event.nuke.power"}].output 50
