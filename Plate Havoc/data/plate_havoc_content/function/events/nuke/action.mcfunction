...
execute if score #EventRunCount plate_havoc.num < #Template.Event.Nuke.MaxRunCount plate_havoc.num run return run function plate_havoc_content:events/nuke/action with storage plate_havoc:events active_data.plate_havoc_content.nuke