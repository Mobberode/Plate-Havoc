execute if score #PHC.Outer_Space_Gravity.Duration plate_havoc.event matches ..0 run return run function plate_havoc_content:events/outer_space_gravity/stage/set_active

scoreboard players add #PHC.Outer_Space_Gravity.StageTicks plate_havoc.event 1
#G * StageCurrent / StageTotal *-0.001
scoreboard players operation #Temp plate_havoc.temp = #PHC.Outer_Space_Gravity.Saved_Multiplier plate_havoc.event
scoreboard players operation #Temp plate_havoc.temp *= #PHC.Outer_Space_Gravity.StageTicks plate_havoc.event
