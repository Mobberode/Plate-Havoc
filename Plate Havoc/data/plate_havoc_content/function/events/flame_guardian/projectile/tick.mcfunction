...
execute as @e[dx=0,type=#plate_havoc:hostile] run function plate_havoc_content:events/flame_guardian/projectile/hurt with storage plate_havoc:events active_data."plate_havoc_content".flame_guardian
