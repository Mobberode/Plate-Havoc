...
#Data
execute store result score #Herobrine.Duration plate_havoc.event run data get storage plate_havoc:custom attributes[{id:"plate_havoc_content:event.herobrine.duration"}].output 20000
execute store result score #Herobrine.Activate_Time plate_havoc.event run data get storage plate_havoc:custom attributes[{id:"plate_havoc_content:event.herobrine.delay"}].output 20000
