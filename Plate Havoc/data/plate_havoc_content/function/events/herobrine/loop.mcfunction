...
execute in plate_havoc:arena as @e[x=0,tag=plate_havoc_content.event.herobrine,type=item_display,limit=1] at @s run function plate_havoc_content:events/herobrine/entity/tick
