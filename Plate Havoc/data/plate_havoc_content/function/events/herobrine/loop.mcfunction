...
execute in plate_havoc:arena as @e[x=0,type=item_display,tag=plate_havoc_content.event.herobrine,limit=1] at @s run function plate_havoc_content:events/herobrine/entity/tick
