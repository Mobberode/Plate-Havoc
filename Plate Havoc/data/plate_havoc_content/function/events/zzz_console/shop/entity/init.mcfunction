...
##Item (PLACE HOLDER)
execute store result score #MaxShop plate_havoc.num if data storage plate_havoc:events active_data.plate_havoc_content.shop[]
execute store result storage plate_havoc:custom max_shop int 1 run scoreboard players remove #MaxShop plate_havoc.num 1

function plate_havoc_content:events/zzz_console/shop/entity/rng/randomize with storage plate_havoc:custom