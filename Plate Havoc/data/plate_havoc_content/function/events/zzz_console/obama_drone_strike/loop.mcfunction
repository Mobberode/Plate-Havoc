execute in plate_havoc:arena as @n[x=0,tag=plate_havoc_content.event.obama_drone_strike,type=item_display] run rotate @s facing entity @p[tag=plate_havoc.survivor]
