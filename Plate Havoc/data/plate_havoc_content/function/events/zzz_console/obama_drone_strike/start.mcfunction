...
execute store result score #ObamaDroneStrike.Summon plate_havoc.event run data get storage plate_havoc:custom attributes[{id:"plate_havoc_content:event.obama_drone_strike.summon.value"}].output
