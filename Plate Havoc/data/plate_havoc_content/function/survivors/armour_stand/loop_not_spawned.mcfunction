...
execute unless predicate plate_havoc:sprint_input unless predicate plate_havoc:moving_input run return run scoreboard players add @s plate_havoc_content.survivor.armour_stand.stand.time 1
