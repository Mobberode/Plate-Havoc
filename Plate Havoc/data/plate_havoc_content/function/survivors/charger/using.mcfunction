...
#X2
execute unless predicate plate_havoc:sneak_input run scoreboard players operation @s plate_havoc_content.survivor.charger.amount -= #SneakLoss plate_havoc_content.survivor.charger.amount
