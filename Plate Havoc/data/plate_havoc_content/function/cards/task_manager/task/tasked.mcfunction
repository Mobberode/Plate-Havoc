...
execute store result storage plate_havoc:cards active_data.global.temp int 1 run scoreboard players get @s plate_havoc_content.card.task_manager.task
function plate_havoc_content:cards/task_manager/task/loop with storage plate_havoc:cards active_data.global
