...
scoreboard players set #Temp plate_havoc.card 1250
scoreboard players set #Temp2 plate_havoc.card 235
##*Cycle
scoreboard players operation #Temp2 plate_havoc.card *= #Value plate_havoc.round
##Apply
execute unless score #Value plate_havoc.round matches ..0 store result storage plate_havoc:cards active_data.shared.temp float 0.001 run scoreboard players operation #Temp plate_havoc.card += #Temp2 plate_havoc.card
