...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.enraged",value:0.5,operation:"add_multiplied_total",tags:["plate_havoc_content:enraged"]}
function plate_havoc:game/misc/attributes/custom/add_modifier
