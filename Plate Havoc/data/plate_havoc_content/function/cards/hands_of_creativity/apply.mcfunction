...
execute if data storage plate_havoc:cards running.total[{id:"plate_havoc_contemt:gods_hand"}] run function plate_havoc_content:cards/hands_of_creativity/gods_hand