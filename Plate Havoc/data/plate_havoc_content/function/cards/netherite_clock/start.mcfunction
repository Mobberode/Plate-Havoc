...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.netherite_clock",value:0.2,operation:"add_value",tags:["plate_havoc_content:netherite_clock"]}
