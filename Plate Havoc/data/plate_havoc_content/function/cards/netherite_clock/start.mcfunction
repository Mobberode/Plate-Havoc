...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.netherite_clock",value:1,operation:"add_multiplied_total",tags:["plate_havoc_content:netherite_clock"]}
