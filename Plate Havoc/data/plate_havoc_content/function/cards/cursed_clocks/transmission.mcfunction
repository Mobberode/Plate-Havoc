execute if score @s plate_havoc_content.card.cursed_clocks.transmission_time matches 600.. run return run function plate_havoc_content:cards/cursed_clocks/curse
