data modify storage plate_havoc:temp group_attribute set value "plate_havoc_content:copper_clock"
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.copper_clock",value:0.1,operation:"add_multiplied_total",tags:["plate_havoc_content:copper_clock"]}
...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.copper_clock",value:-0.02,operation:"add_value",tags:["plate_havoc_content:copper_clock"]}
function plate_havoc:misc/attributes/custom/add_modifier
