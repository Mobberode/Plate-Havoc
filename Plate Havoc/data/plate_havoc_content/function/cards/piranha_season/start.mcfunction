...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.piranha_season",value:0.75,operation:"add_multiplied_total",tags:["plate_havoc_content:piranha_season"]}
