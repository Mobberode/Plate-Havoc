...
data remove storage plate_havoc:custom attributes[{id:"plate_havoc:intensity.gain"}].modifiers[{id:"plate_havoc_content:card.time_panic"}]
data modify storage plate_havoc:temp id_attribute set value "plate_havoc:intensity.gain"
$data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.time_panic",value:$(temp2),operation:"add_multiplied_total",temporary:true,tags:["plate_havoc_content:time_panic"]}
function plate_havoc:game/misc/attributes/custom/add_modifier

function plate_havoc:game/misc/attributes/custom/input {id:"plate_havoc:intensity.gain"}
scoreboard players operation #PHC.Time_Panic plate_havoc.temp = #Temp plate_havoc.temp