...
$data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.time_panic",value:$(temp),operation:"add_multiplied_total",temporary:true,tags:["plate_havoc_content:time_panic"],temporary:true}
