execute if score @s plate_havoc.c.card.cube_of_decay.time_threshold < @s plate_havoc.timer run function plate_havoc_content:cards/cube_of_decay/roll_positive
