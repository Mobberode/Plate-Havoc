...
scoreboard players operation @s plate_havoc_content.card.cube_of_decay.shrink_player_requirement /= #2 plate_havoc.num
scoreboard players set @s[scores={plate_havoc_content.card.cube_of_decay.shrink_player_requirement=..0}] plate_havoc_content.card.cube_of_decay.shrink_player_requirement 1
