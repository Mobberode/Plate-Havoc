schedule function plate_havoc_content:cards/cube_of_decay/loop 1t
...
scoreboard players operation @s plate_havoc_content.card.cube_of_decay.shrink_player_requirement = #Current plate_havoc.players
scoreboard players operation @s[scores={plate_havoc_content.card.cube_of_decay.shrink_player_requirement=2..}] plate_havoc_content.card.cube_of_decay.shrink_player_requirement /= #2 plate_havoc.num
function plate_havoc_content:cards/cube_of_decay/values with storage plate_havoc:cards active_data.plate_havoc_content.cube_of_decay
