...
execute summon item_display run function plate_havoc_content:cards/void_implosions/entity/set_passenger
...
function plate_havoc_content:cards/void_implosions/entity/offset