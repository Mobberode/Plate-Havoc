...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.diamond_clock",value:0.15,operation:"add_multiplied_total",tags:["plate_havoc_content:diamond_clock"]}
function plate_havoc:game/misc/attributes/custom/add_modifier
