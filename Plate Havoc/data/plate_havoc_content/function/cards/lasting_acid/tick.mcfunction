...
scoreboard players remove @s[scores={plate_havoc_content.card.lasting_acid=1..}] plate_havoc_content.card.lasting_acid 1

execute if score @s plate_havoc_content.event.acid_rain.exposure matches 1.. run scoreboard players set @s plate_havoc_content.card.lasting_acid 200
