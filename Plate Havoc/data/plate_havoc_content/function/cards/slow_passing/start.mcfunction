...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.slow_passing",value:-0.8,operation:"add_multiplied_total",tags:["plate_havoc_content:slow_passing"]}
function plate_havoc:misc/attributes/custom/add_modifier
