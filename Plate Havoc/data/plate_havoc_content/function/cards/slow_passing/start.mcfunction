...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.slow_passing",value:-0.999,operation:"add_multiplied_total",tags:["plate_havoc_content:slow_passing"]}
function plate_havoc:game/misc/attributes/custom/add_modifier

data modify storage plate_havoc:temp group_attribute set value "plate_havoc_content:slow_passing.applicable"
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.slow_passing",value:0.33,operation:"add_multiplied_total",tags:["plate_havoc_content:slow_passing"]}
