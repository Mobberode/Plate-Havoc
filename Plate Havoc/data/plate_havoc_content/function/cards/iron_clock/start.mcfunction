...
data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.iron_clock",value:0.005,operation:"add_value",tags:["plate_havoc_content:iron_clock"]}
function plate_havoc:game/misc/attributes/custom/add_modifier
