...
$data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.life_harmony",value:$(temp),operation:"add_value",temporary:true,tags:["plate_havoc_content:life_harmony"]}
