...
$data modify storage plate_havoc:custom attribute_modifier set value {id:"plate_havoc_content:card.life_harmony",value:$(temp),operation:"add_multiplied_total",tags:["plate_havoc_content:life_harmony"],temporary:true}
...
scoreboard players operation #PHC.Life_Harmony.Previous plate_havoc.temp = #PHC.Life_Harmony.Current plate_havoc.temp