...
execute \
    ...
    run return run function plate_player_motion:internal/launch/main
...
### Convert local x/y to global x/y because the broken rotation is within the global space
    ...
    execute as d4bd74a7-4e82-4a07-8850-dfc4d89f9e2f in minecraft:overworld positioned 0.0 0.0 0.0 run \
        function plate_player_motion:internal/math/polar_local_xy_to_global with storage plate_player_motion:internal/temp matrix
###
