#> plate_player_motion:internal/launch/main
##
...
item replace entity @s saddle with saddle[\
    ...
    enchantments={"plate_player_motion:internal/apply_impulse": 1} \
]

## Convert the internal launch vector from scores into a binary score tree for use by `apply_impulse` enchantment
function plate_player_motion:internal/store/x
function plate_player_motion:internal/store/y
function plate_player_motion:internal/store/z
...
execute if predicate plate_player_motion:internal/falling_creative_player \
