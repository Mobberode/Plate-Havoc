...
execute store result storage plate_player_motion:internal/temp convert.index int 1 run scoreboard players get #bucket_index player_motion.internal.dummy
...
execute store result score #y player_motion.internal.dummy store result storage plate_player_motion:internal/temp matrix.y double 1 run \
