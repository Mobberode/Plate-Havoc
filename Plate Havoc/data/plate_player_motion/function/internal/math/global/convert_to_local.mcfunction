...
execute store result score #x player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_i[0] 100000
execute store result score #vec_i.z player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_i[2] 100000

execute store result score #y player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_j[0] 100000
execute store result score #vec_j.y player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_j[1] 100000
execute store result score #vec_j.z player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_j[2] 100000

execute store result score #z player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_k[0] 100000
execute store result score #vec_k.y player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_k[1] 100000
execute store result score #vec_k.z player_motion.internal.dummy run data get storage plate_player_motion:internal/temp vec_k[2] 100000
