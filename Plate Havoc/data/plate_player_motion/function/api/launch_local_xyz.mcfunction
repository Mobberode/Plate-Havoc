#> plate_player_motion:api/launch_local_xyz
##
...
### Else, proceed with rotation calculation
    ...
    execute store result storage plate_player_motion:internal/temp matrix.x double 1 run \
        scoreboard players get #x player_motion.internal.dummy
    execute store result storage plate_player_motion:internal/temp matrix.y double 1 run \
        scoreboard players get #y player_motion.internal.dummy
    execute store result storage plate_player_motion:internal/temp matrix.z double 1 run \
